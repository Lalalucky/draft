...
layui.define(['jquery', 'form', 'layer', 'element'], function(exports) {
	 ...
	 * 如果有子级就展开，没有就打开frame
	 */
	$('.top_nav #nav>li .sub_menu>li').click(function(event) {
        var _url = $(this).find('a').attr('_href');     //   url名字
		console.log(_url)
		setTimeout(function () {
			var t=document.getElementById('weIframe');
            t.contentWindow.location.href =_url;
        })
	});
